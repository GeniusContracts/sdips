...
(*                                               (* day   min   sec *)
  ...
  let current_mttr    =  624n * mttr_decimals / 24n / 60n / 60n in*)
                                              ...
                                              (* day   min   sec *)
  let current_cut_90  = (70n * mttr_decimals) / 24n / 60n / 60n in
  let current_cut_70  = (141n * mttr_decimals) / 24n / 60n / 60n in
  let current_cut_50  = (353n * mttr_decimals) / 24n / 60n / 60n in

  let current_double  = 1415n * mttr_decimals / 24n / 60n / 60n in

  let current_mttrwtz =  624n * mttr_decimals / 24n / 60n / 60n in
  let current_mttr    =  312n * mttr_decimals / 24n / 60n / 60n in
  ...
  let change_mttr_1 : operation = get_mttr_op(("2022-07-30T20:00:00Z" : timestamp), new_farm_config_1) in
  let change_mttr_2 : operation = get_mttr_op(("2022-08-06T20:00:00Z" : timestamp), new_farm_config_2) in
  let change_mttr_3 : operation = get_mttr_op(("2022-08-13T20:00:00Z" : timestamp), new_farm_config_3) in
...
(*
ligo compile expression cameligo get_lambda --init-file 'lambda_mttr_contract_7_30.mligo'

{ PUSH (lambda          (pair timestamp (map (pair address nat) (pair bool nat nat (option nat))))          operation)       { UNPAIR ;         PUSH address "KT1K4jn23GonEmZot3pMGth7unnzZ6EaMVjY" ;         CONTRACT %addConfig           (pair (timestamp %active_time)                 (map %farm_configs                    (pair (address %fa2_address) (nat %token_id))                    (pair (bool %claimable) (nat %fee) (nat %reward_per_sec) (option %total_out nat)))                 (option %allow_list_id nat)) ;         IF_NONE { PUSH string "FATAL3" ; FAILWITH } {} ;         PUSH mutez 0 ;         NONE nat ;         DIG 4 ;         DIG 4 ;         PAIR 3 ;         TRANSFER_TOKENS } ;  PAIR ;  { CAR ;    PUSH nat 0 ;    PUSH address "KT1FHewqgFXCjTJbYvLMhWL335ZV1qupN1c2" ;    PAIR ;    PUSH nat 0 ;    PUSH address "KT1KgNVokovu4dSBFZXmFXgUni5TypwMBbRS" ;    PAIR ;    PUSH nat 0 ;    PUSH address "KT1M234AC3kz9uQ9vse8caidhKUMrZ3S2YjN" ;    PAIR ;    PUSH nat 0 ;    PUSH address "KT1NN1NgmKFTW5FUWiyxVjUt3kH9bCiqgxLW" ;    PAIR ;    PUSH nat 0 ;    PUSH address "KT1UefQz7nP8BuuDk5Dd5LWo22N1ZPB7JB5o" ;    PAIR ;    PUSH nat 0 ;    PUSH address "KT1VAbfwhE9DaZWdja4hg6CF77YPc1Ne9qvK" ;    PAIR ;    PUSH nat 0 ;    PUSH address "KT1WiDfeeRVpY2ao4ps4oJUgXi1wMWtD6sFa" ;    PAIR ;    PUSH nat 0 ;    PUSH address "KT1GeH12st1t3sVnvUDxR8UKm6ouXxai1vnp" ;    PAIR ;    PUSH nat 0 ;    PUSH address "KT1QQvdg7TGZAH85HtgNvQuoekNRegvQPk8R" ;    PAIR ;    PUSH nat 0 ;    PUSH address "KT1K4jn23GonEmZot3pMGth7unnzZ6EaMVjY" ;    PAIR ;    PUSH nat 1000000000000 ;    PUSH nat 60 ;    PUSH nat 60 ;    PUSH nat 24 ;    DUP 4 ;    PUSH nat 70 ;    MUL ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    PUSH nat 60 ;    PUSH nat 60 ;    PUSH nat 24 ;    DUP 5 ;    PUSH nat 141 ;    MUL ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    PUSH nat 60 ;    PUSH nat 60 ;    PUSH nat 24 ;    DUP 6 ;    PUSH nat 353 ;    MUL ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    PUSH nat 60 ;    PUSH nat 60 ;    PUSH nat 24 ;    DUP 7 ;    PUSH nat 1415 ;    MUL ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    PUSH nat 60 ;    PUSH nat 60 ;    PUSH nat 24 ;    DUP 8 ;    PUSH nat 624 ;    MUL ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    PUSH nat 60 ;    PUSH nat 60 ;    PUSH nat 24 ;    DIG 8 ;    PUSH nat 312 ;    MUL ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    EDIV ;    IF_NONE { PUSH string "DIV by 0" ; FAILWITH } {} ;    CAR ;    PUSH nat 50000000000000000 ;    PUSH nat 5000000000000000 ;    NONE nat ;    DIG 8 ;    DUP 4 ;    PUSH bool True ;    PAIR 4 ;    NONE nat ;    DIG 8 ;    DUP 5 ;    PUSH bool True ;    PAIR 4 ;    NONE nat ;    DIG 8 ;    DUP 6 ;    PUSH bool True ;    PAIR 4 ;    NONE nat ;    DIG 8 ;    DIG 6 ;    PUSH bool True ;    PAIR 4 ;    NONE nat ;    DIG 7 ;    DUP 7 ;    PUSH bool True ;    PAIR 4 ;    NONE nat ;    DIG 7 ;    DIG 7 ;    PUSH bool True ;    PAIR 4 ;    EMPTY_MAP (pair address nat) (pair bool nat nat (option nat)) ;    DUP 7 ;    DUP 12 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 7 ;    DUP 11 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 4 ;    DUP 14 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 7 ;    DUP 17 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 7 ;    DUP 13 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 7 ;    DUP 18 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    SWAP ;    DUP ;    DUG 2 ;    DUP 9 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 3 ;    DUP 10 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 7 ;    DUP 15 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 7 ;    DUP 16 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    PUSH timestamp "2022-07-30T20:00:00Z" ;    PAIR ;    DUP 18 ;    SWAP ;    EXEC ;    EMPTY_MAP (pair address nat) (pair bool nat nat (option nat)) ;    DUP 7 ;    DUP 13 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 7 ;    DUP 12 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 5 ;    DUP 15 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 7 ;    DUP 18 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 7 ;    DUP 14 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 7 ;    DUP 19 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 3 ;    DUP 10 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 4 ;    DUP 11 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DIG 6 ;    DUP 15 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 7 ;    DUP 16 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    PUSH timestamp "2022-08-06T20:00:00Z" ;    PAIR ;    DUP 18 ;    SWAP ;    EXEC ;    EMPTY_MAP (pair address nat) (pair bool nat nat (option nat)) ;    DUP 7 ;    DIG 12 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 7 ;    DIG 11 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DIG 5 ;    DIG 11 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 6 ;    DIG 13 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 6 ;    DIG 10 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DUP 6 ;    DIG 12 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DIG 3 ;    DIG 7 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DIG 3 ;    DIG 6 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DIG 3 ;    DIG 5 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    DIG 3 ;    DIG 4 ;    SWAP ;    SOME ;    SWAP ;    UPDATE ;    PUSH timestamp "2022-08-13T20:00:00Z" ;    PAIR ;    DIG 3 ;    SWAP ;    EXEC ;    NIL operation ;    SWAP ;    CONS ;    SWAP ;    CONS ;    SWAP ;    CONS } }    
*)
